...
namespace Commands
{
	...
	class CreateGeometryShader : public CommandWithAllocator<CreateGeometryShader,CreateShaderBase>
	{
	public:
		CreateGeometryShader()		
		{
			CommandId = idCreateGeometryShader;
		}

		CreateGeometryShader(const unsigned int*  pCode, 
