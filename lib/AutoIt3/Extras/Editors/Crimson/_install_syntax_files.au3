...
$answer = MsgBox(4, "Crimson Editor", "This script will attempt to automatically install syntax highlighting files for Crimson Editor.  Run?")
If $answer = 7 Then Exit

; Find an verify the installation directory
$installdir = RegRead("HKEY_LOCAL_MACHINE\Software\Crimson System\Crimson Editor", "InstallDir")
If @error Then Error()

$spec = $installdir & "\spec\"
