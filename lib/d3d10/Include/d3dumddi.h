...
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETRENDERSTATE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_RENDERSTATE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_UPDATEWINFO)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_WINFO*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_VALIDATEDEVICE)(
        __in HANDLE hDevice, __inout D3DDDIARG_VALIDATETEXTURESTAGESTATE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETTEXTURESTAGESTATE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_TEXTURESTAGESTATE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETTEXTURE)(
        __in HANDLE hDevice, __in UINT, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETPIXELSHADER)(
        __in HANDLE hDevice, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETPIXELSHADERCONST)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETPIXELSHADERCONST*, __in CONST FLOAT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETSTREAMSOURCEUM)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETSTREAMSOURCEUM*, __in CONST VOID*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETINDICES)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETINDICES*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETINDICESUM)(
        __in HANDLE hDevice, __in UINT, __in CONST VOID*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DRAWPRIMITIVE)(                                    
        __in HANDLE hDevice, __in CONST D3DDDIARG_DRAWPRIMITIVE*, __in_opt CONST UINT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DRAWINDEXEDPRIMITIVE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DRAWINDEXEDPRIMITIVE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DRAWRECTPATCH)(                                    
        __in HANDLE hDevice, __in CONST D3DDDIARG_DRAWRECTPATCH*, __in CONST D3DDDIRECTPATCH_INFO*, __in CONST FLOAT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DRAWTRIPATCH)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DRAWTRIPATCH*, __in CONST D3DDDITRIPATCH_INFO*, __in CONST FLOAT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DRAWPRIMITIVE2)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DRAWPRIMITIVE2*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DRAWINDEXEDPRIMITIVE2)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DRAWINDEXEDPRIMITIVE2*, __in UINT, __in CONST VOID*, __in_opt CONST UINT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_VOLBLT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_VOLUMEBLT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_BUFBLT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_BUFFERBLT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_TEXBLT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_TEXBLT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_STATESET)(
        __in HANDLE hDevice, __in D3DDDIARG_STATESET*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETPRIORITY)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETPRIORITY*);    
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CLEAR)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_CLEAR*, __in UINT, __in CONST RECT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_UPDATEPALETTE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_UPDATEPALETTE*, __in CONST PALETTEENTRY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETPALETTE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETPALETTE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERCONST)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETVERTEXSHADERCONST*, __in CONST VOID*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_MULTIPLYTRANSFORM)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_MULTIPLYTRANSFORM*); 
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETTRANSFORM)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETTRANSFORM*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETVIEWPORT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_VIEWPORTINFO*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETZRANGE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_ZRANGE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETMATERIAL)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETMATERIAL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETLIGHT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETLIGHT*, __in CONST D3DDDI_LIGHT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATELIGHT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_CREATELIGHT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYLIGHT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DESTROYLIGHT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETCLIPPLANE)(                             
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETCLIPPLANE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_GETINFO)(
        __in HANDLE hDevice, __in UINT, __out_bcount(DevInfoSize)VOID*, __in UINT DevInfoSize);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_LOCK)(
        __in HANDLE hDevice, __inout D3DDDIARG_LOCK*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_UNLOCK)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_UNLOCK*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_LOCKASYNC)(
        __in HANDLE hDevice, __inout D3DDDIARG_LOCKASYNC*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_UNLOCKASYNC)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_UNLOCKASYNC*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_RENAME)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_RENAME*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATERESOURCE)(
        __in HANDLE hDevice, __inout D3DDDIARG_CREATERESOURCE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYRESOURCE)(
        __in HANDLE hDevice, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETDISPLAYMODE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETDISPLAYMODE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_PRESENT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_PRESENT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_FLUSH)(
        __in HANDLE hDevice);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEVERTEXSHADERDECL)(
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEVERTEXSHADERDECL*, __in CONST D3DDDIVERTEXELEMENT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERDECL)(
        __in HANDLE hDevice, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DELETEVERTEXSHADERDECL)(
        __in HANDLE hDevice, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEVERTEXSHADERFUNC)(
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEVERTEXSHADERFUNC*, __in CONST UINT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERFUNC)(
        __in HANDLE hDevice, __in HANDLE);
typedef __in HRESULT (APIENTRY *PFND3DDDI_DELETEVERTEXSHADERFUNC)(
        __in HANDLE hDevice, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERCONSTI)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETVERTEXSHADERCONSTI*, __in CONST INT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETVERTEXSHADERCONSTB)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETVERTEXSHADERCONSTB*, __in CONST BOOL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETSCISSORRECT)(
        __in HANDLE hDevice, __in CONST RECT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETSTREAMSOURCE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETSTREAMSOURCE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETSTREAMSOURCEFREQ)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETSTREAMSOURCEFREQ*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETCONVOLUTIONKERNELMONO)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETCONVOLUTIONKERNELMONO*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_COMPOSERECTS)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_COMPOSERECTS*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_BLT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_BLT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_COLORFILL)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_COLORFILL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DEPTHFILL)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DEPTHFILL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEQUERY)(
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEQUERY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYQUERY)(
        __in HANDLE hDevice, __in CONST HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_ISSUEQUERY)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_ISSUEQUERY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_GETQUERYDATA)(
        __in HANDLE hDevice, __inout CONST D3DDDIARG_GETQUERYDATA*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETRENDERTARGET)(                          
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETRENDERTARGET*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETDEPTHSTENCIL)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETDEPTHSTENCIL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_GENERATEMIPSUBLEVELS)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_GENERATEMIPSUBLEVELS*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETPIXELSHADERCONSTI)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETPIXELSHADERCONSTI*, __in CONST INT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETPIXELSHADERCONSTB)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETPIXELSHADERCONSTB*, __in CONST BOOL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEPIXELSHADER)(
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEPIXELSHADER*, __in CONST UINT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DELETEPIXELSHADER)(
        __in HANDLE hDevice, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEDECODEDEVICE)(
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEDECODEDEVICE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYDECODEDEVICE)(
        __in HANDLE hDevice, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETDECODERENDERTARGET) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETDECODERENDERTARGET*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DECODEBEGINFRAME) (
        __in HANDLE hDevice, __in D3DDDIARG_DECODEBEGINFRAME*); 
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DECODEENDFRAME) (
        __in HANDLE hDevice, __inout D3DDDIARG_DECODEENDFRAME*);  
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DECODEEXECUTE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DECODEEXECUTE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DECODEEXTENSIONEXECUTE)(
        __in HANDLE hDevice, __inout CONST D3DDDIARG_DECODEEXTENSIONEXECUTE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEVIDEOPROCESSDEVICE) (
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEVIDEOPROCESSDEVICE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYVIDEOPROCESSDEVICE) (
        __in HANDLE hDevice, __in HANDLE hVideoProcessor);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_VIDEOPROCESSBEGINFRAME) (
        __in HANDLE hDevice, __in HANDLE hVideoProcess);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_VIDEOPROCESSENDFRAME) (
        __in HANDLE hDevice, __inout D3DDDIARG_VIDEOPROCESSENDFRAME*);                   
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETVIDEOPROCESSRENDERTARGET) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETVIDEOPROCESSRENDERTARGET*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_VIDEOPROCESSBLT) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_VIDEOPROCESSBLT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEEXTENSIONDEVICE) (
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEEXTENSIONDEVICE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYEXTENSIONDEVICE) (
        __in HANDLE hDevice, __in HANDLE hExtension);                                
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_EXTENSIONEXECUTE) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_EXTENSIONEXECUTE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYDEVICE)(
        __in HANDLE hDevice);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEOVERLAY) (
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEOVERLAY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_UPDATEOVERLAY) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_UPDATEOVERLAY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_FLIPOVERLAY) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_FLIPOVERLAY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_GETOVERLAYCOLORCONTROLS) (
        __in HANDLE hDevice, __inout D3DDDIARG_GETOVERLAYCOLORCONTROLS*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_SETOVERLAYCOLORCONTROLS) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_SETOVERLAYCOLORCONTROLS*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYOVERLAY) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_DESTROYOVERLAY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_QUERYRESOURCERESIDENCY) (
        __in HANDLE hDevice, __in CONST D3DDDIARG_QUERYRESOURCERESIDENCY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_OPENRESOURCE) (
        __in HANDLE hDevice, __inout D3DDDIARG_OPENRESOURCE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_GETCAPTUREALLOCATIONHANDLE)(
        __in HANDLE hDevice, __inout D3DDDIARG_GETCAPTUREALLOCATIONHANDLE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CAPTURETOSYSMEM)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_CAPTURETOSYSMEM*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DXVAHD_CREATEVIDEOPROCESSOR)(
        __in HANDLE, __inout D3DDDIARG_DXVAHD_CREATEVIDEOPROCESSOR*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DXVAHD_SETVIDEOPROCESSBLTSTATE)(
        __in HANDLE, __in CONST D3DDDIARG_DXVAHD_SETVIDEOPROCESSBLTSTATE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DXVAHD_GETVIDEOPROCESSBLTSTATEPRIVATE)(
        __in HANDLE, __inout D3DDDIARG_DXVAHD_GETVIDEOPROCESSBLTSTATEPRIVATE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DXVAHD_SETVIDEOPROCESSSTREAMSTATE)(
        __in HANDLE, __in CONST D3DDDIARG_DXVAHD_SETVIDEOPROCESSSTREAMSTATE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DXVAHD_GETVIDEOPROCESSSTREAMSTATEPRIVATE)(
        __in HANDLE, __inout D3DDDIARG_DXVAHD_GETVIDEOPROCESSSTREAMSTATEPRIVATE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DXVAHD_VIDEOPROCESSBLTHD)(
        __in HANDLE, __in CONST D3DDDIARG_DXVAHD_VIDEOPROCESSBLTHD*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DXVAHD_DESTROYVIDEOPROCESSOR)(
        __in HANDLE, __in HANDLE);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEAUTHENTICATEDCHANNEL)(
        __in HANDLE hDevice, __inout D3DDDIARG_CREATEAUTHENTICATEDCHANNEL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_AUTHENTICATEDCHANNELKEYEXCHANGE)(
        __in HANDLE hDevice, __inout D3DDDIARG_AUTHENTICATEDCHANNELKEYEXCHANGE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_QUERYAUTHENTICATEDCHANNEL)(
        __in HANDLE hDevice, __inout CONST D3DDDIARG_QUERYAUTHENTICATEDCHANNEL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CONFIGUREAUTHENICATEDCHANNEL)(
        __in HANDLE hDevice, __inout CONST D3DDDIARG_CONFIGUREAUTHENTICATEDCHANNEL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYAUTHENTICATEDCHANNEL)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DESTROYAUTHENTICATEDCHANNEL*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATECRYPTOSESSION)(
        __in HANDLE hDevice, __inout D3DDDIARG_CREATECRYPTOSESSION*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CRYPTOSESSIONKEYEXCHANGE)(
        __in HANDLE hDevice, __inout D3DDDIARG_CRYPTOSESSIONKEYEXCHANGE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DESTROYCRYPTOSESSION)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DESTROYCRYPTOSESSION*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_ENCRYPTIONBLT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_ENCRYPTIONBLT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_GETPITCH)(
        __in HANDLE hDevice, __inout D3DDDIARG_GETPITCH*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_STARTSESSIONKEYREFRESH)(
        __in HANDLE hDevice, __inout CONST D3DDDIARG_STARTSESSIONKEYREFRESH*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_FINISHSESSIONKEYREFRESH)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_FINISHSESSIONKEYREFRESH*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_GETENCRYPTIONBLTKEY)(
        __in HANDLE hDevice, __inout CONST D3DDDIARG_GETENCRYPTIONBLTKEY*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_DECRYPTIONBLT)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_DECRYPTIONBLT*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_RESOLVESHAREDRESOURCE)(
        __in HANDLE hDevice, __in CONST D3DDDIARG_RESOLVESHAREDRESOURCE*);
...
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_ALLOCATECB)(
        __in HANDLE hDevice, __inout D3DDDICB_ALLOCATE*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_DEALLOCATECB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_DEALLOCATE*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_SETPRIORITYCB)(
        __in HANDLE hDevice, __in D3DDDICB_SETPRIORITY*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_QUERYRESIDENCYCB)(
        __in HANDLE hDevice, __inout CONST D3DDDICB_QUERYRESIDENCY*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_SETDISPLAYMODECB)(
        __in HANDLE hDevice, __inout D3DDDICB_SETDISPLAYMODE*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_SETDISPLAYPRIVATEDRIVERFORMATCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_SETDISPLAYPRIVATEDRIVERFORMAT*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_PRESENTCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_PRESENT*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_RENDERCB)(
        __in HANDLE hDevice, __inout D3DDDICB_RENDER*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_LOCKCB)(
        __in HANDLE hDevice, __inout D3DDDICB_LOCK*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_UNLOCKCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_UNLOCK*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_ESCAPECB)(
        __in HANDLE hAdapter, __inout CONST D3DDDICB_ESCAPE*);  
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_CREATEOVERLAYCB)(
        __in HANDLE hDevice, __inout D3DDDICB_CREATEOVERLAY*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_UPDATEOVERLAYCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_UPDATEOVERLAY*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_FLIPOVERLAYCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_FLIPOVERLAY*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_DESTROYOVERLAYCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_DESTROYOVERLAY*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_CREATECONTEXTCB)(
        __in HANDLE hDevice, __inout D3DDDICB_CREATECONTEXT*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_DESTROYCONTEXTCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_DESTROYCONTEXT*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_CREATESYNCHRONIZATIONOBJECTCB)(
        __in HANDLE hDevice, __inout D3DDDICB_CREATESYNCHRONIZATIONOBJECT*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_DESTROYSYNCHRONIZATIONOBJECTCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_DESTROYSYNCHRONIZATIONOBJECT*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_WAITFORSYNCHRONIZATIONOBJECTCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_WAITFORSYNCHRONIZATIONOBJECT*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_SIGNALSYNCHRONIZATIONOBJECTCB)(
        __in HANDLE hDevice, __in CONST D3DDDICB_SIGNALSYNCHRONIZATIONOBJECT*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_SETASYNCCALLBACKSCB)(
        __in HANDLE hDevice, __in BOOL Enable);
...
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_QUERYADAPTERINFOCB)(
        __in HANDLE hAdapter, __inout CONST D3DDDICB_QUERYADAPTERINFO*);
typedef __checkReturn HRESULT (APIENTRY CALLBACK *PFND3DDDI_GETMULTISAMPLEMETHODLISTCB)(
        __in HANDLE hAdapter, __inout D3DDDICB_GETMULTISAMPLEMETHODLIST*);
...
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_GETCAPS)(
        __in HANDLE hAdapter, __inout CONST D3DDDIARG_GETCAPS*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CREATEDEVICE)(
        __in HANDLE hAdapter, __inout D3DDDIARG_CREATEDEVICE*);
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_CLOSEADAPTER)(
...
typedef __checkReturn HRESULT (APIENTRY *PFND3DDDI_OPENADAPTER)(
        __inout D3DDDIARG_OPENADAPTER*);
...
#define D3DDDI_VERSION64_FROM16( maj, min, bld, rev ) \
    ((((UINT64)(UINT16)maj) << 48) | (((UINT64)(UINT16)min) << 32) | (((UINT64)(UINT16)bld) << 16) | ((UINT64)(UINT16)maj))
