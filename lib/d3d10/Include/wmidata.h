...
// MSNdis_NicSwitchQueryParameters - MSNdis_NicSwitchQueryParameters
#define MSNdis_NicSwitchQueryParametersGuid \
    { 0x4002d4cf,0x462b,0x4afa, { 0xbc,0x5f,0xf9,0xe3,0xb2,0xa5,0x32,0x64 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSNdis_NicSwitchQueryParameters_GUID, \
            0x4002d4cf,0x462b,0x4afa,0xbc,0x5f,0xf9,0xe3,0xb2,0xa5,0x32,0x64);
#endif


typedef struct _MSNdis_NicSwitchQueryParameters
{
    // 
    MSNdis_ObjectHeader Header;
    #define MSNdis_NicSwitchQueryParameters_Header_SIZE sizeof(MSNdis_ObjectHeader)
    #define MSNdis_NicSwitchQueryParameters_Header_ID 1

    // 
    ULONG EnabledCapabilities;
    #define MSNdis_NicSwitchQueryParameters_EnabledCapabilities_SIZE sizeof(ULONG)
    #define MSNdis_NicSwitchQueryParameters_EnabledCapabilities_ID 2

} MSNdis_NicSwitchQueryParameters, *PMSNdis_NicSwitchQueryParameters;

#define MSNdis_NicSwitchQueryParameters_SIZE (FIELD_OFFSET(MSNdis_NicSwitchQueryParameters, EnabledCapabilities) + MSNdis_NicSwitchQueryParameters_EnabledCapabilities_SIZE)
...
typedef struct _MSNdis_NicSwitchCapabilities
{
    ...
    #define MSNdis_NicSwitchCapabilities_NicSwitchCapabilities_SIZE sizeof(ULONG)
    #define MSNdis_NicSwitchCapabilities_NicSwitchCapabilities_ID 3
    ...
    // 
    ULONG NumPortsMCPktsReplicated;
    #define MSNdis_NicSwitchCapabilities_NumPortsMCPktsReplicated_SIZE sizeof(ULONG)
    #define MSNdis_NicSwitchCapabilities_NumPortsMCPktsReplicated_ID 7

    // 
    ULONG NumPortsBCPktsReplicated;
    #define MSNdis_NicSwitchCapabilities_NumPortsBCPktsReplicated_SIZE sizeof(ULONG)
    #define MSNdis_NicSwitchCapabilities_NumPortsBCPktsReplicated_ID 8

} MSNdis_NicSwitchCapabilities, *PMSNdis_NicSwitchCapabilities;

#define MSNdis_NicSwitchCapabilities_SIZE (FIELD_OFFSET(MSNdis_NicSwitchCapabilities, NumPortsBCPktsReplicated) + MSNdis_NicSwitchCapabilities_NumPortsBCPktsReplicated_SIZE)
...
// MSNdis_QueryNicSwitchParameters - MSNdis_QueryNicSwitchParameters
#define MSNdis_QueryNicSwitchParametersGuid \
    { 0x3f2c141f,0x83bc,0x11dd, { 0x94,0xb8,0x00,0x1d,0x09,0x16,0x2b,0xc3 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSNdis_QueryNicSwitchParameters_GUID, \
            0x3f2c141f,0x83bc,0x11dd,0x94,0xb8,0x00,0x1d,0x09,0x16,0x2b,0xc3);
#endif

//
// Method id definitions for MSNdis_QueryNicSwitchParameters
#define WmiQueryNicSwitchParameters     1
typedef struct _WmiQueryNicSwitchParameters_IN
{
    // 
    MSNdis_WmiMethodHeader Header;
    #define WmiQueryNicSwitchParameters_IN_Header_SIZE sizeof(MSNdis_WmiMethodHeader)
    #define WmiQueryNicSwitchParameters_IN_Header_ID 1

} WmiQueryNicSwitchParameters_IN, *PWmiQueryNicSwitchParameters_IN;

#define WmiQueryNicSwitchParameters_IN_SIZE (FIELD_OFFSET(WmiQueryNicSwitchParameters_IN, Header) + WmiQueryNicSwitchParameters_IN_Header_SIZE)

typedef struct _WmiQueryNicSwitchParameters_OUT
{
    // 
    MSNdis_NicSwitchQueryParameters NicSwitchParameters;
    #define WmiQueryNicSwitchParameters_OUT_NicSwitchParameters_SIZE sizeof(MSNdis_NicSwitchQueryParameters)
    #define WmiQueryNicSwitchParameters_OUT_NicSwitchParameters_ID 2

} WmiQueryNicSwitchParameters_OUT, *PWmiQueryNicSwitchParameters_OUT;

#define WmiQueryNicSwitchParameters_OUT_SIZE (FIELD_OFFSET(WmiQueryNicSwitchParameters_OUT, NicSwitchParameters) + WmiQueryNicSwitchParameters_OUT_NicSwitchParameters_SIZE)
