...
DECLARE_HANDLE(NvEventHandle);              // A handle to an event registration instance
...
#define NV_CHIPSET_INFO_VER  MAKE_NVAPI_VERSION(NV_CHIPSET_INFO, 2)
...
//                             mask that corresponds to the current message
//                objectId     Uniqe Id of the object that corresponds to the
//                             current message
