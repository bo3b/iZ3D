...
{
	return new InterlacedOutput( nMode_, nSpanMode_ );
}

InterlacedOutput::InterlacedOutput( DWORD nMode_, DWORD nSpanMode_ )
...
InterlacedOutput::~InterlacedOutput()
{
}

void InterlacedOutput::InitializeResources( D3DDeviceWrapper* pD3DWrapper_ )
{
...
void InterlacedOutput::SetStates(  D3DDeviceWrapper* pDevice_, D3DSwapChain* pSwapChain_ )
{
...
void InterlacedOutput::ClearResources( D3DDeviceWrapper* pD3DWrapper_ )
{
	D3D10DDI_DEVICEFUNCS& GET_ORIG = pD3DWrapper_->OriginalDeviceFuncs;
	D3D10DDI_HDEVICE hDevice = pD3DWrapper_->hDevice;
