...
{
	return new InterlacedOutput(mode, spanMode);
}
...
InterlacedOutput::InterlacedOutput(DWORD mode, DWORD spanMode)
: PostprocessedOutput(mode, spanMode)
{
}

InterlacedOutput::~InterlacedOutput(void)
{
}

HRESULT InterlacedOutput::InitializeResources()
{
	HRESULT res = S_OK;
...
HRESULT InterlacedOutput::SetStates(CBaseSwapChain* pSwapChain)
{
	HRESULT res = S_OK;
