...
{
	return new iZShutterOutput( nMode_, nSpanMode_ );
}

iZShutterOutput::iZShutterOutput( DWORD nMode_, DWORD nSpanMode_ )
...
void iZShutterOutput::Output(bool bLeft_, D3DSwapChain* pSwapChain_, RECT* pDestRect_)
{
...
void iZShutterOutput::Initialize( D3DDeviceWrapper* pD3DWrapper_ )
{
...
void iZShutterOutput::Clear( D3DDeviceWrapper* pD3DWrapper_ )
{
	D3D10DDI_HDEVICE hDevice	= pD3DWrapper_->GetHandle();
...
bool iZShutterOutput::FindAdapter( IDXGIFactory* pDXGIFactory_ )
{
	return true;
}