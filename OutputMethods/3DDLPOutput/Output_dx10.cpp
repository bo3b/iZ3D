...
{
	return new DLP3DOutput( nMode_, nSpanMode_ );
}

DLP3DOutput::DLP3DOutput( DWORD nMode_, DWORD nSpanMode_ )
...
DLP3DOutput::~DLP3DOutput()
{
}

void DLP3DOutput::InitializeResources( D3DDeviceWrapper* pD3DWrapper_ )
{
...
void DLP3DOutput::SetStates(  D3DDeviceWrapper* pDevice_, D3DSwapChain* pSwapChain_ )
{
...
void DLP3DOutput::ClearResources( D3DDeviceWrapper* pD3DWrapper_ )
{
	D3D10DDI_DEVICEFUNCS& GET_ORIG = pD3DWrapper_->OriginalDeviceFuncs;
	D3D10DDI_HDEVICE hDevice = pD3DWrapper_->hDevice;
