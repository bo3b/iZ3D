...
{
	return new ZalmanOutput( nMode_, nSpanMode_ );
}

ZalmanOutput::ZalmanOutput( DWORD nMode_, DWORD nSpanMode_ )
...
ZalmanOutput::~ZalmanOutput()
{
}

void ZalmanOutput::InitializeResources( D3DDeviceWrapper* pD3DWrapper_ )
{
...
void ZalmanOutput::SetStates(  D3DDeviceWrapper* pDevice_, D3DSwapChain* pSwapChain_ )
{
...
void ZalmanOutput::ClearResources( D3DDeviceWrapper* pD3DWrapper_ )
{
	D3D10DDI_DEVICEFUNCS& GET_ORIG = pD3DWrapper_->OriginalDeviceFuncs;
	D3D10DDI_HDEVICE hDevice = pD3DWrapper_->hDevice;
