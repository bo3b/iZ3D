...
* $URL$
*/
// DLP3DOutput.cpp : Defines the entry point for the DLL application.
//
...
{
	return new ATIDLP3DOutput(mode, spanMode);
}
...
ATIDLP3DOutput::ATIDLP3DOutput(DWORD mode, DWORD spanMode)
: PostprocessedOutput(mode, spanMode)
{
}

ATIDLP3DOutput::~ATIDLP3DOutput(void)
{
}

HRESULT ATIDLP3DOutput::InitializeResources()
{
	HRESULT res = S_OK;
...
HRESULT ATIDLP3DOutput::SetStates(CBaseSwapChain* pSwapChain)
{
...
bool ATIDLP3DOutput::FindAdapter( LPDIRECT3D9 pDirect3D9, UINT DeviceNum, D3DDEVTYPE &DeviceType, UINT Adapters[2] )
{
