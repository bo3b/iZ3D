...
{
	return new TaerimOutput(mode, spanMode);
}
...
TaerimOutput::TaerimOutput(DWORD mode, DWORD spanMode)
: PostprocessedOutput(mode, spanMode)
{
}

TaerimOutput::~TaerimOutput(void)
{
}

HRESULT TaerimOutput::InitializeResources()
{
	HRESULT res = S_OK;
...
HRESULT TaerimOutput::SetStates(CBaseSwapChain* pSwapChain)
{
	HRESULT res = S_OK;
