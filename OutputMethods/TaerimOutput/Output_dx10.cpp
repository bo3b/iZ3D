...
{
	return new TaerimOutput( nMode_, nSpanMode_ );
}

TaerimOutput::TaerimOutput( DWORD nMode_, DWORD nSpanMode_ )
...
TaerimOutput::~TaerimOutput()
{
}

void TaerimOutput::InitializeResources( D3DDeviceWrapper* pD3DWrapper_ )
{
...
void TaerimOutput::SetStates(  D3DDeviceWrapper* pDevice_, D3DSwapChain* pSwapChain_ )
{
...
void TaerimOutput::ClearResources( D3DDeviceWrapper* pD3DWrapper_ )
{
	D3D10DDI_DEVICEFUNCS& GET_ORIG = pD3DWrapper_->OriginalDeviceFuncs;
	D3D10DDI_HDEVICE hDevice = pD3DWrapper_->hDevice;
