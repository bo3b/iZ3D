...
@fxc.exe shaders_dx10.psh %PARAMS% /EshaderVerticalInterlaced /FhShaders_dx10\shaderVerticalInterlaced.h
...
@fxc.exe shaders_dx10.psh %PARAMS% /EshaderVerticalInterlacedOptimized /FhShaders_dx10\shaderVerticalInterlacedOptimized.h
