...
* $Date: $
* $LastChangedBy: $
* $URL: svn://svn.neurok.ru/dev/driver/trunk/OutputMethods/3DDLPOutput/Output_dx9.cpp $
*/
...
void AnaglyphOutput::InitializeResources(D3DDeviceWrapper* pD3DWrapper)
{	
...
void AnaglyphOutput::ClearResources( D3DDeviceWrapper* pD3DWrapper )
{
	D3D10DDI_DEVICEFUNCS& GET_ORIG = pD3DWrapper->OriginalDeviceFuncs;
	D3D10DDI_HDEVICE hDevice = pD3DWrapper->hDevice;
